...
import sys
import os
from pymoncore.services import get_static_info
from pymoncore.services import get_current_frequency
from pymoncore.services import get_usage_per_core
from pymoncore.services import get_total_cpu_usage
from
